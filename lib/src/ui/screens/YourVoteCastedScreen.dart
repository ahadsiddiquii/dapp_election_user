...
class YourVoteCastedScreen extends StatefulWidget {
  final ElectionEvent eEvent;
  const YourVoteCastedScreen({this.eEvent, Key key}) : super(key: key);

  static const routeName = '/yourvotecasted-screen';

  @override
  _YourVoteCastedScreenState createState() => _YourVoteCastedScreenState();
}

class _YourVoteCastedScreenState extends State<YourVoteCastedScreen> {
